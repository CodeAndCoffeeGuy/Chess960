      ...
      {/* Board Themes */}
        ...
        <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 gap-2">
          {boardThemes.map((theme) => {
            // Shorten two-word theme names for mobile
            ...
            return (
              ...
              >
                ...
                <div className="text-center">
                  <span className="text-xs font-medium text-[#c1b9ad] light:text-[#5a5449] group-hover:text-white light:group-hover:text-black transition-colors sm:hidden">
                    {getMobileName(theme.name)}
                  </span>
                  <span className="text-xs font-medium text-[#c1b9ad] light:text-[#5a5449] group-hover:text-white light:group-hover:text-black transition-colors hidden sm:inline">
                    {theme.name}
                  </span>
                </div>
