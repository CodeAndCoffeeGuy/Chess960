      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        {session && (
          <div className="flex justify-center gap-2 sm:gap-4 mb-8 flex-wrap px-4">
            <Link
              href="/tournaments/my"
              className="inline-flex items-center gap-2 px-3 sm:px-6 py-3 bg-[#35322e] light:bg-white hover:bg-[#3a3632] light:hover:bg-[#f5f1ea] border border-[#474239] light:border-[#d4caba] hover:border-orange-300/50 text-white light:text-black rounded-lg font-semibold transition-all duration-200 text-sm sm:text-base"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-3 sm:px-6 py-3 bg-[#35322e] light:bg-white hover:bg-[#3a3632] light:hover:bg-[#f5f1ea] border border-[#474239] light:border-[#d4caba] hover:border-orange-300/50 text-white light:text-black rounded-lg font-semibold transition-all duration-200 text-sm sm:text-base"
            >
              <Calendar className="h-4 w-4 sm:h-5 sm:w-5 text-orange-300" />
              Calendar
            </Link>
          </div>
        )}
        ...
        {!loading && (
          <>
            {tournaments.length === 0 ? (
              <div className="text-center py-16">
                <Trophy className="h-16 w-16 text-[#6b6460] light:text-[#a0958a] mx-auto mb-4" />
                <p className="text-xl text-[#a0958a] light:text-[#5a5449]">No tournaments found</p>
                {!session && (
