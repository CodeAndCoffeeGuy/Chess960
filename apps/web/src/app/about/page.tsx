    ...
    <div className="min-h-screen bg-[#1f1d1a] light:bg-[#f5f1ea] text-white light:text-black">
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <AnimatedSection className="mb-16">
          ...
          <div className="bg-[#35322e] light:bg-white border border-[#474239] light:border-[#d4caba] rounded-2xl p-8">
            <p className="text-[#c1b9ad] light:text-[#5a5449] text-lg leading-relaxed mb-4">
              Chess960.game was created to be the premier online platform for Fischer Random Chess. Our vision
        ...
        <AnimatedSection className="mb-16">
          ...
          <div className="bg-[#35322e] light:bg-white border border-[#474239] light:border-[#d4caba] rounded-2xl p-8">
            <p className="text-[#c1b9ad] light:text-[#5a5449] text-lg leading-relaxed mb-6">
              Chess960.game offers a complete Chess960 experience across all time controls:
            </p>
            <ul className="space-y-4 text-[#c1b9ad] light:text-[#5a5449] ml-6 mb-4">
              <li className="flex items-start">
                <span className="text-orange-400 mr-3 mt-1 text-xl">•</span>
        ...
        <AnimatedSection className="mb-16">
          ...
          <div className="bg-[#35322e] light:bg-white border border-[#474239] light:border-[#d4caba] rounded-2xl p-8">
            <p className="text-[#c1b9ad] light:text-[#5a5449] text-lg leading-relaxed mb-4">
              Chess960.game is proudly open source, released under the GNU Affero General Public License v3.0. We believe in
            ...
            <p className="text-[#c1b9ad] light:text-[#5a5449] text-lg leading-relaxed mb-4">
              ...
              <a href="https://github.com/CodeAndCoffeeGuy/Chess960" className="text-orange-400 hover:text-orange-300 transition-colors">
                GitHub
              </a>
              , where you can:
            </p>
            ...
            <p className="text-[#c1b9ad] light:text-[#5a5449] text-lg leading-relaxed mb-4">
              ...
              <a href="https://github.com/CodeAndCoffeeGuy/Chess960/blob/main/CONTRIBUTING.md" className="text-orange-400 hover:text-orange-300 transition-colors">
            ...
            <div className="mt-6">
              <a
                href="/source"
                className="inline-block bg-gradient-to-r from-orange-300 to-orange-400 hover:from-orange-600 hover:to-red-700 text-white px-8 py-3 rounded-lg font-semibold transition-all duration-200 shadow-lg hover:shadow-xl text-center"
              >
