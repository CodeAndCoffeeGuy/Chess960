...
export default function SignInPage() {
  ...
  const handleOAuthSignIn = async (provider: 'google' | 'apple') => {
    ...
    setError(null);
    try {
      // For OAuth, we want the default redirect behavior
      ...
      <div className="relative max-w-md w-full space-y-6 sm:space-y-8 p-4 sm:p-6 md:p-8 bg-[#35322e]/50 light:bg-white/70 backdrop-blur-sm rounded-2xl border border-[#474239] light:border-[#d4caba] shadow-[0_12px_34px_rgba(0,0,0,0.45)] light:shadow-[0_12px_34px_rgba(0,0,0,0.1)] mx-4 sm:mx-0">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-[#474239] light:border-[#d4caba] rounded-lg text-white light:text-black bg-[#2a2723] light:bg-white hover:bg-[#35322e] light:hover:bg-[#f5f1ea] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading === 'google' ? (
